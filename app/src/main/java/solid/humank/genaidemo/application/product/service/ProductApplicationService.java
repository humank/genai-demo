 ...
 */
@Service
public class ProductApplicationService implements solid.humank.genaidemo.application.product.port.incoming.ProductManagementUseCase {
     ...
     * 更新產品信息
     */
    public ProductDto updateProduct(solid.humank.genaidemo.application.product.dto.command.UpdateProductCommand command) {
        ...
        Product updatedProduct = new Product(
            id,
            new solid.humank.genaidemo.domain.product.model.valueobject.ProductName(command.getName()),
            new solid.humank.genaidemo.domain.product.model.valueobject.ProductDescription(command.getDescription()),
    ...
    private ProductDto toDto(Product product) {
        return new ProductDto(
                ...
                new PriceDto(product.getPrice().getAmount(), product.getPrice().getCurrency().getCurrencyCode()),
