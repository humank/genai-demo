...
public record ProfileConfigurationProperties(
    ...
    public static ProfileConfigurationProperties developmentDefaults() {
        return new ProfileConfigurationProperties("development", "Development environment", ProfileFeatures.developmentDefaults());
    }
    ...
    public static ProfileConfigurationProperties productionDefaults() {
        return new ProfileConfigurationProperties("production", "Production environment", ProfileFeatures.productionDefaults());
    }
}