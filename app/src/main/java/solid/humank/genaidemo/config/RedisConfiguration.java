...
public class RedisConfiguration {
    ...
    public void setLockWatchdogTimeout(long lockWatchdogTimeout) { this.lockWatchdogTimeout = lockWatchdogTimeout; }
    
    public long getDefaultLockWaitTime() { return defaultLockWaitTime; }
    public void setDefaultLockWaitTime(long defaultLockWaitTime) { this.defaultLockWaitTime = defaultLockWaitTime; }
    
    public long getDefaultLockLeaseTime() { return defaultLockLeaseTime; }
    public void setDefaultLockLeaseTime(long defaultLockLeaseTime) { this.defaultLockLeaseTime = defaultLockLeaseTime; }
    ...
    public HighAvailabilityConfig getHighAvailability() { return highAvailability; }
    public void setHighAvailability(HighAvailabilityConfig highAvailability) { this.highAvailability = highAvailability; }
    ...
    public static class ClusterConfig {
        ...
        public int getMaxRedirections() { return maxRedirections; }
        ...
        public boolean isReadFromSlaves() { return readFromSlaves; }
        public void setReadFromSlaves(boolean readFromSlaves) { this.readFromSlaves = readFromSlaves; }
        
        public int getSlaveConnectionPoolSize() { return slaveConnectionPoolSize; }
        public void setSlaveConnectionPoolSize(int slaveConnectionPoolSize) { this.slaveConnectionPoolSize = slaveConnectionPoolSize; }
        
        public int getMasterConnectionPoolSize() { return masterConnectionPoolSize; }
        public void setMasterConnectionPoolSize(int masterConnectionPoolSize) { this.masterConnectionPoolSize = masterConnectionPoolSize; }
    }
    ...
    public static class SentinelConfig {
        ...
        public boolean isCheckSentinelsList() { return checkSentinelsList; }
        public void setCheckSentinelsList(boolean checkSentinelsList) { this.checkSentinelsList = checkSentinelsList; }
    ...
    public static class HighAvailabilityConfig {
        ...
        // Getters and setters
        public boolean isEnableFailover() { return enableFailover; }
        public void setEnableFailover(boolean enableFailover) { this.enableFailover = enableFailover; }
        
        public int getFailoverTimeout() { return failoverTimeout; }
        public void setFailoverTimeout(int failoverTimeout) { this.failoverTimeout = failoverTimeout; }
        
        public int getMaxFailoverAttempts() { return maxFailoverAttempts; }
        public void setMaxFailoverAttempts(int maxFailoverAttempts) { this.maxFailoverAttempts = maxFailoverAttempts; }
        
        public int getFailoverRetryInterval() { return failoverRetryInterval; }
        public void setFailoverRetryInterval(int failoverRetryInterval) { this.failoverRetryInterval = failoverRetryInterval; }
        
        public boolean isEnableConnectionRecovery() { return enableConnectionRecovery; }
        public void setEnableConnectionRecovery(boolean enableConnectionRecovery) { this.enableConnectionRecovery = enableConnectionRecovery; }
        
        public int getConnectionRecoveryInterval() { return connectionRecoveryInterval; }
        public void setConnectionRecoveryInterval(int connectionRecoveryInterval) { this.connectionRecoveryInterval = connectionRecoveryInterval; }
    ...
    public static class HealthCheckConfig {
        ...
        public void setInfoEnabled(boolean infoEnabled) { this.infoEnabled = infoEnabled; }
    }
}