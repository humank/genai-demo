...
public class CustomerNotificationPreferenceService {
    ...
    public CustomerNotificationPreferenceService(CustomerNotificationPreferenceRepository preferenceRepository) {
     ...
     * @return 是否更新成功
     */
    public boolean updateCustomerPreference(String customerId, List<NotificationType> selectedTypes, List<NotificationChannel> selectedChannels) {
    ...
    public boolean shouldSendNotificationType(String customerId, NotificationType type) {
        ...
        return preference.map(p -> p.shouldSendNotificationType(type))
    ...
    public List<NotificationChannel> getPreferredChannels(String customerId) {
        ...
        return preference.map(CustomerNotificationPreference::getPreferredChannels)
