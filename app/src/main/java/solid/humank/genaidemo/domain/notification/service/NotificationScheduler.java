...
public class NotificationScheduler {
    ...
    public void processPendingNotifications() {
        ...
        List<Notification> pendingNotifications =
                notificationRepository.findPendingNotificationsScheduledBefore(LocalDateTime.now());
    ...
    public void retryFailedNotifications() {
        // 獲取需要重試的通知
        List<Notification> notificationsForRetry =
                notificationRepository.findNotificationsForRetry(MAX_RETRY_COUNT);
