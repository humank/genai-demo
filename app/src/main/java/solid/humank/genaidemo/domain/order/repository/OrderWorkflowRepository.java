...
/** 訂單工作流儲存庫接口 */
@solid.humank.genaidemo.domain.common.annotations.Repository(name = "OrderWorkflowRepository", description = "訂單工作流聚合根儲存庫")
public interface OrderWorkflowRepository
        extends solid.humank.genaidemo.domain.common.repository.BaseRepository<OrderWorkflow, WorkflowId> {
