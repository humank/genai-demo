...
public class PaymentFailedEvent extends AbstractDomainEvent {
    ...
    public PaymentFailedEvent(
            PaymentId paymentId, OrderId orderId, Money amount, String failureReason) {
     ...
     * @return 支付失敗事件
     */
    public static PaymentFailedEvent fromUUID(
            UUID paymentId, UUID orderId, Money amount, String failureReason) {
        return new PaymentFailedEvent(
                PaymentId.fromUUID(paymentId), OrderId.fromUUID(orderId), amount, failureReason);
    }
