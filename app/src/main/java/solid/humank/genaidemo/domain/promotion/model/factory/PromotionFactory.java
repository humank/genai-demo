...
public class PromotionFactory {
    ...
    public static Promotion createAddOnPurchasePromotion(
            String name, String description, LocalDateTime startDate, LocalDateTime endDate,
            String mainProductId, String addOnProductId, double specialPrice, double regularPrice) {
        ...
        Promotion promotion = new Promotion(promotionId, name, description, startDate, endDate, rule);
    ...
    public static Promotion createFlashSalePromotion(
            String name, String description, LocalDateTime startDate, LocalDateTime endDate,
            String productId, double specialPrice, double regularPrice,
            LocalDateTime flashSaleStartTime, LocalDateTime flashSaleEndTime, ZoneId timeZone) {
    ...
    public static Promotion createLimitedQuantityPromotion(
            String name, String description, LocalDateTime startDate, LocalDateTime endDate,
            String productId, double specialPrice, double regularPrice, int quantity) {
        
        PromotionId promotionId = new PromotionId();
        
        LimitedQuantityRule rule = new LimitedQuantityRule(
            new ProductId(productId),
            Money.of(specialPrice),
            Money.of(regularPrice),
            quantity,
    ...
    public static Promotion createGiftWithPurchasePromotion(
            String name, String description, LocalDateTime startDate, LocalDateTime endDate,
            double minimumPurchaseAmount, String giftProductId, double giftValue,
    ...
    public static Promotion createConvenienceStoreVoucherPromotion(
            String name, String description, LocalDateTime startDate, LocalDateTime endDate,
            String voucherName, double price, double regularPrice, int validDays,
            String redemptionLocation, String contents, int quantity) {
