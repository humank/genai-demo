...
public record ReviewApprovedEvent(
     ...
     * @return 評價審核通過事件
     */
    public static ReviewApprovedEvent create(ReviewId reviewId, ProductId productId, CustomerId reviewerId) {
        DomainEvent.EventMetadata metadata = DomainEvent.createEventMetadata();
        return new ReviewApprovedEvent(reviewId, productId, reviewerId,
