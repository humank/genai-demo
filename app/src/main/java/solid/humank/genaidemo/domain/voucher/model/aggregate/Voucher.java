package solid.humank.genaidemo.domain.voucher.model.aggregate;

import java.time.LocalDateTime;
import solid.humank.genaidemo.domain.common.annotations.AggregateRoot;
import solid.humank.genaidemo.domain.common.valueobject.Money;
import solid.humank.genaidemo.domain.customer.model.valueobject.CustomerId;
import solid.humank.genaidemo.domain.voucher.exception.VoucherAlreadyUsedException;
import solid.humank.genaidemo.domain.voucher.exception.VoucherExpiredException;
import solid.humank.genaidemo.domain.voucher.model.valueobject.VoucherCode;
import solid.humank.genaidemo.domain.voucher.model.valueobject.VoucherId;
import solid.humank.genaidemo.domain.voucher.model.valueobject.VoucherStatus;
import solid.humank.genaidemo.domain.voucher.model.valueobject.VoucherType;

/** 超商優惠券聚合根 */
@AggregateRoot(name = "Voucher", description = "超商優惠券聚合根，管理優惠券的完整生命週期")
