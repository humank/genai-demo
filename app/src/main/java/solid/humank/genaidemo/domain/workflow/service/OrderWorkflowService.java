...
public class OrderWorkflowService {
    ...
    public boolean checkInventory(WorkflowId workflowId) {
        ...
        boolean isSufficient =
                inventoryService.checkInventory(workflow.getOrderId(), workflow.getProductIds());
    ...
    public boolean processPayment(
        ...
        boolean isSuccessful =
                paymentService.processPayment(workflow.getOrderId(), paymentMethod, paymentDetails);
    ...
    private void sendInsufficientInventoryNotification(OrderWorkflow workflow) {
        ...
        List<String> outOfStockProducts =
                inventoryService.getOutOfStockProducts(workflow.getOrderId());

        // 獲取替代商品建議
        Map<String, String> alternativeProducts =
                inventoryService.getAlternativeProducts(outOfStockProducts);
