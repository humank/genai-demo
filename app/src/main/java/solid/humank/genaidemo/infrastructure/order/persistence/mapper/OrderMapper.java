    ...
    public static Order toDomainEntity(JpaOrderEntity jpaEntity) {
        try {
            ...
            Constructor<Order> constructor = Order.class.getDeclaredConstructor(
                    OrderId.class, CustomerId.class, String.class,
                    List.class, OrderStatus.class, Money.class,
                    Money.class, java.time.LocalDateTime.class, java.time.LocalDateTime.class);
