...
public class PaymentGatewayAdapter implements PaymentGatewayPort {
    ...
    public String processCreditCardPayment(
            UUID orderId, Money amount, String cardNumber, String expiryDate, String cvv) {
        // 模擬與外部支付網關的交互
    ...
    public String processBankTransfer(
            UUID orderId, Money amount, String accountNumber, String bankCode) {
        // 模擬與外部銀行系統的交互
        ...
        switch (paymentMethod) {
            case CREDIT_CARD:
                return processCreditCardPayment(
                        orderId, amount, "4111111111111111", "12/2025", "123");
            case BANK_TRANSFER:
    ...
    private void validateTransaction(String transactionId) {
        ...
        if (transactionId == null
                || (!transactionId.startsWith("CC-TXN-") && !transactionId.startsWith("BT-TXN-"))) {
