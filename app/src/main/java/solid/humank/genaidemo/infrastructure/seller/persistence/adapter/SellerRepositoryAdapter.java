...
public class SellerRepositoryAdapter
    ...
    @Override
    public List<Seller> findByRatingBetween(double minRating, double maxRating) {
    ...
    @Override
    public List<Seller> findByVerificationStatus(String verificationStatus) {
    ...
    @Override
    public Optional<Seller> findByBusinessLicense(String businessLicense) {
        return jpaSellerRepository.findByBusinessLicense(businessLicense)
                .map(mapper::toDomainModel);
    }
