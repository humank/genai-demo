...
public class PromotionArchitectureTest {
    ...
    private static final String PROMOTION_SPECIFICATION_PACKAGE =
            PROMOTION_MODEL_PACKAGE + "specification..";
    private static final String PROMOTION_VALUEOBJECT_PACKAGE =
            PROMOTION_MODEL_PACKAGE + "valueobject..";
    private static final String PROMOTION_ENTITY_PACKAGE = PROMOTION_MODEL_PACKAGE + "entity..";
    private static final String PROMOTION_AGGREGATE_PACKAGE =
            PROMOTION_MODEL_PACKAGE + "aggregate..";
    ...
    void promotionSpecificationsShouldImplementSpecificationInterface() {
        ArchRule rule =
                classes()
                        .that()
                        .resideInAPackage(PROMOTION_SPECIFICATION_PACKAGE)
                        .and()
    ...
    void promotionValueObjectsShouldResideInCorrectPackage() {
        ArchRule rule =
                classes()
                        ...
                        .or()
                        .haveSimpleNameEndingWith("Type")
                        .and()
                        .resideInAPackage(PROMOTION_PACKAGE)
                        .should()
                        .resideInAPackage(PROMOTION_VALUEOBJECT_PACKAGE);
    ...
    void promotionEntitiesShouldResideInCorrectPackage() {
        ArchRule rule =
                classes()
                        .that()
                        .haveSimpleName("Voucher")
                        .and()
                        .resideInAPackage(PROMOTION_PACKAGE)
                        .should()
                        .resideInAPackage(PROMOTION_ENTITY_PACKAGE);
    ...
    void promotionAggregatesShouldResideInCorrectPackage() {
        ArchRule rule =
                classes()
                        .that()
                        .haveSimpleName("Promotion")
                        .and()
                        .resideInAPackage(PROMOTION_PACKAGE)
                        .should()
                        .resideInAPackage(PROMOTION_AGGREGATE_PACKAGE);
    ...
    void promotionFactoryShouldCreatePromotionAggregates() {
        ArchRule rule =
                classes()
                        .that()
                        .haveSimpleName("PromotionFactory")
                        .should()
                        .dependOnClassesThat()
                        .haveSimpleName("Promotion");
