...
/** 業務流程事件整合測試 重構後遵循3A原則，每個測試方法只測試一個特定場景 */
@SpringBootTest
...
public class BusinessFlowEventIntegrationTest {
    ...
    @Mock private OrderEventHandler orderEventHandler;
    ...
    public void shouldPublishOrderItemAddedEventWhenItemIsAdded() {
        ...
        AddOrderItemCommand addItemCommand =
                OrderTestDataBuilder.anOrder()
                        .withItem(
                                "product-123", "iPhone 15", 1, TestConstants.Product.DEFAULT_PRICE)
    ...
    public void shouldHandleEventsCorrectlyWhenExceptionOccurs() {
        ...
        assertTrue(
                exception.getMessage().contains(TestConstants.ErrorMessages.ORDER_NO_ITEMS),
    ...
    private String createTestOrderWithItemAndGetId() {
        ...
        AddOrderItemCommand addItemCommand =
                OrderTestDataBuilder.anOrder().withDefaultItem().buildAddItemCommand(orderId);
