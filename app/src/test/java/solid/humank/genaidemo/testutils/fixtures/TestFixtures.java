...
public class TestFixtures {
     ...
     */
    public static AddOrderItemCommand addOrderItemCommand(String orderId, String productId, 
    ...
    public static Order orderWithItems() {
        return OrderTestDataBuilder.anOrder()
            .withCustomerId(DEFAULT_CUSTOMER_ID)
            .withShippingAddress(DEFAULT_SHIPPING_ADDRESS)
            .withItem(DEFAULT_PRODUCT_ID, DEFAULT_PRODUCT_NAME, DEFAULT_QUANTITY, DEFAULT_PRODUCT_PRICE)
            .build();
    }
