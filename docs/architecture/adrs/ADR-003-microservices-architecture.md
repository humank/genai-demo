# ADR-003: Microservices Architecture Design

This document describes the architectural design principles and implementation methods for ADR-003: Microservices Architecture Design.
