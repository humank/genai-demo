# ADR-004: Saga Pattern Selection

This document describes the architectural design principles and implementation methods for ADR-004: Saga Pattern Selection.
