...
本文檔展示 GenAI Demo 專案的完整 AWS 基礎設施架構，包括所有 CDK 堆疊、服務和環境配置。
...
2. **Observability Stack**: 可觀測性服務，包括監控、日誌和追蹤
...
- **Amazon ECR**: 容器映像註冊表
- **Fargate**: 無伺服器運算節點
- **Graviton3**: ARM64 高性能實例

#### 資料服務
- **RDS PostgreSQL**: 多可用區、加密的關聯式資料庫
...
- **[部署視點](../viewpoints/deployment/README.md)** - 部署策略和環境管理
