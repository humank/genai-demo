<!-- This file is auto-translated from docs/en/requirements/promotion-pricing/product-pricing-promotion-rules.md -->
<!-- 此檔案由 docs/en/requirements/promotion-pricing/product-pricing-promotion-rules.md 自動翻譯而來 -->
