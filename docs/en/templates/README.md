...
├── viewpoint-template.md               # Templates
├── perspective-template.md             # Templates
├── metadata-standards.md               # Standards
├── diagram-metadata-standards.md       # Standards
└── examples/                           # Examples
...
**使用場景**: 創建七大Architectural Viewpoint文件時使用
...
**使用場景**: 創建八大Architectural Perspective文件時使用

**步驟**:
1. 複製 `perspective-template.md` 到目標位置
2. 根據具體觀點更新 Front Matter 元資料
3. 填寫Cross-Viewpoint Application章節
4. 定義Quality Attribute和度量Metrics
...
- [ ] `quality_attributes`: 相關Quality Attribute
- [ ] `last_updated`: 最後更新日期
- [ ] `version`: 版本號
- [ ] `author`: 作者或團隊
...
這個模板系統確保了文件的一致性、Maintainability和自動化處理能力，支援整個專案的文件Refactoring需求。