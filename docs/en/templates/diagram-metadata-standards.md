...
本文件定義了專案中所有圖表檔案的元資料標準格式，包括 Mermaid、PlantUML 和 Excalidraw 圖表的元資料規範，確保圖表的可Tracing性、自動化處理和一致性管理。
...
- **viewpoint**: 所屬的Architectural Viewpoint
- **perspective**: 相關的Architectural Perspective陣列
...
description: "展示Customer註冊、驗證和管理的完整流程"
...
description: "展示領域模型的詳細設計，包括Aggregate Root、Entity和Value Object"
...
description: "展示訂單Aggregate Root的詳細設計，包括Entity關係和業務方法"
plantuml_type: "class"
style_theme: "plain"
