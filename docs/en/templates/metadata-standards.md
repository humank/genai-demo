...
本文件定義了專案中所有文件的元資料 Front Matter 標準格式，確保文件的一致性、可Tracing性和自動化處理能力。
...
- **viewpoint**: 所屬的Architectural Viewpoint，必須是七大視點之一
...
- **perspective**: 相關的Architectural Perspective陣列，可以是多個
- **stakeholders**: 相關Stakeholder陣列
...
- **quality_attributes**: 相關的Quality Attribute
- **last_updated**: 最後更新日期
- **version**: 文件版本號
- **author**: 文件作者
...
- **stakeholders**: 相關Stakeholder
- **related_perspectives**: 相關的其他觀點
- **related_documents**: 相關文件
- **patterns**: 相關的Design Pattern
- **tools**: 相關的工具和技術
- **metrics**: 相關的度量Metrics
- **review_status**: 審查狀態
- **impact_level**: 影響程度
...
```yaml
---
title: "領域模型類圖 - CustomerAggregate"
type: "plantuml"
format: "puml"
viewpoint: "functional"
...
description: "展示CustomerAggregate Root的詳細設計，包括Entity、Value Object和Domain Service"
...
complexity: "high"
maintenance_notes: "當CustomerAggregate Root發生變更時需要更新此圖表"
...
這個標準格式確保了文件的一致性和Maintainability，同時支援自動化處理和分析。