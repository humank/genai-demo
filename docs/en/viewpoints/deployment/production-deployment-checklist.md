...
- **[Security Perspective](../../perspectives/security/README.md)**: 安全配置和合規檢查
- **[Availability & Resilience Perspective](../../perspectives/availability/README.md)**: 災難恢復和備份Policy

## 相關文檔

- [ObservabilityDeployment指南](observability-deployment.md)
