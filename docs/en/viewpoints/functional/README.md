...
``` - 完整系統架構概覽，展示用戶角色、前端應用、API網關、Microservices Architecture、基礎設施、Observability和安全合規
...
- ## Hexagonal Architecture概覽 (Mermaid)
...
``` - Monitoring、Logging、Tracing系統架構
