...
本指南詳細說明如何配置前端後端Observability整合系統，包括Environment差異化配置、MSK 主題設定和Monitoring配置。
...
- [配置架構圖](../../diagrams/viewpoints/operational/configuration-architecture.mmd)
- [Environment配置對比](../../diagrams/viewpoints/operational/environment-config-comparison.puml)

## Relationships with Other Viewpoints

- **[Deployment Viewpoint](../deployment/README.md)**: DeploymentEnvironment的配置管理
- **[Development Viewpoint](../development/README.md)**: 開發Environment的配置設定
- **[Security Perspective](../../perspectives/security/README.md)**: 安全配置和加密設定

## 相關文檔

- [Observability系統概覽](observability-overview.md)
- [生產Environment測試指南](production-observability-testing-guide.md)
