...
This project integrates Model Context Protocol (MCP) to provide AI-assisted development capabilities. MCP is an open standard that allows AI assistants to interact with various tools and services.
...
- **Functionality**: Time and timezone conversion
- **Usage**: Get current time, timezone conversion, time formatting
- **Status**: ✅ Stable operation

#### 📚 AWS Documentation Server

- **Functionality**: AWS official documentation search and query
- **Usage**: Real-time AWS service documentation search, best practices queries
- **Status**: ✅ Stable operation

#### 🏗️ AWS CDK Server

- **Functionality**: CDK development guidance and best practices
- **Usage**: CDK Nag rule explanations, architecture guidance, best practice recommendations
- **Status**: ✅ Stable operation

#### 💰 AWS Pricing Server

- **Functionality**: AWS cost analysis and pricing queries
...
- **Functionality**: GitHub operations and workflow management
...
"What are Lambda function best practices?"
...
2. Confirm `uv` and `uvx` are installed
...
- Regularly clean unused servers
...
- **Documentation Query Time**: 70% reduction (from manual search to instant queries)
- **Architecture Decision Speed**: 50% improvement (instant best practice recommendations)
- **Cost Assessment Accuracy**: 80% improvement (real-time pricing queries and analysis)
- **Code Review Efficiency**: 60% improvement (automated GitHub operations)
...
- **AWS EC2 Server**: EC2 instance management (removed, planned for re-integration)
...
- **Documentation Sync**: Automatic project documentation and API specification updates

## 📚 Related Resources

- MCP Official Documentation
- AWS Labs MCP Servers
- Kiro IDE MCP Integration Guide
- UV Package Manager

---

**Note**: MCP integration requires stable network connection and appropriate system resources. It's recommended to use in a good network environment and regularly update MCP servers to get the latest features.