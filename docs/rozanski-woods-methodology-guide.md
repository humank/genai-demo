...
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  Security         ◄──── Applied across all viewpoints      │
│  Performance      ◄──── Applied across all viewpoints      │
│  Availability     ◄──── Applied across all viewpoints      │
│  Evolution        ◄──── Applied across all viewpoints      │
│  ...                                                        │
│                                                             │
...
**Viewpoints** answer questions like:

- What does the system do? (Functional)
- How is data organized? (Information)
- How is it deployed? (Deployment)

**Perspectives** answer questions like:

- Is it secure? (Security)
- Is it fast enough? (Performance)
- Can it handle failures? (Availability)
