...
This document provides a comprehensive guide to the technology stack and toolchain, including backend technologies, frontend technologies, testing frameworks, infrastructure, build and deployment, and quality assurance for all technical components.
...
// Using startTransition to optimize user experience
...
#### Angular 18 Features Application
...
export class ProductListComponent {
  ...
  constructor() {
    // Using effect for reactive updates
    effect(() => {
      this.loadProducts();
    });
  }
...
```java
// JUnit 5 + Mockito + AssertJ Integration
...
class CustomerServiceTest {
    ...
    @Test
    @DisplayName("Should successfully create customer and send welcome email")
    void should_create_customer_and_send_welcome_email() {
        // Given - Using AssertJ fluent API
...
public class CustomerStepDefinitions {
    ...
    @When("submitting customer creation request")
...
```gherkin
# features/customer-management.feature
Feature: Customer Management
  As a system administrator
  I want to manage customer accounts
  So that I can maintain customer data

  Scenario: Create a new customer with valid data
    Given a valid customer data
    When submitting customer creation request
    Then should successfully create customer
    And customer should receive welcome email

  Scenario Outline: Reject invalid customer data
    Given customer data with name "<name>" and email "<email>"
    When submitting customer creation request
    Then should return status code <status>
...
- [Testing Standards](../../../../.kiro/steering/test-performance-standards.md)
