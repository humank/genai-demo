...
import { AlertTriangle, Archive, ArrowLeft, CheckCircle, DollarSign, Package, Tag } from 'lucide-react'
...
import { useDeleteProduct, useInventory, useProduct } from '@repo/api-client/hooks'
  ...
  const handleDeleteProduct = async () => {
    ...
    if (confirmed) {
      try {
        ...
        toast({ title: '刪除產品時發生錯誤', variant: 'destructive' })
