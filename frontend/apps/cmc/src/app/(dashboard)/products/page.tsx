...
import { useProducts } from '@repo/api-client/hooks'
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <main className="container-modern py-8 space-y-8">
        ...
        <div className="grid-stats">
          <StatsCard title="商品總數" value={totalProducts} icon={Package} color="blue" loading={isLoading} />
          <StatsCard
            title="有庫存"
          ...
          <StatsCard
            ...
            loading={isLoading}
          />
          <StatsCard title="庫存價值" value={`NT$ ${totalValue.toLocaleString()}`} icon={DollarSign} color="purple" loading={isLoading} />
        </div>
        ...
        {filteredProducts.length > 0 && (
          <div className="flex justify-center items-center space-x-4 text-sm text-muted-foreground">
            ...
            {categoryFilter !== 'ALL' && (<span>• 分類: {categoryFilter}</span>)}
          </div>
        )}
      </main>
    </div>
