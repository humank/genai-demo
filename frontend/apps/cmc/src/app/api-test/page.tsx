          ...
          <div className={`p-4 rounded ${testResults.directFetch.success ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
            ...
            {testResults.directFetch.success ? (
              <div>
                ...
                <p>獨特客戶: {testResults.directFetch.data?.totalCustomers}</p>
          ...
          <div className="space-y-2">
            ...
            {statsData && (
              <div className="mt-4">
                ...
                <p>總訂單: {Number(statsData.totalOrders)}</p>
                <p>獨特客戶: {Number(statsData.totalCustomers)}</p>
                <p>總庫存: {Number(statsData.totalInventory)}</p>
              </div>
            )}
