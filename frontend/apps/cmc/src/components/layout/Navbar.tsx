          ...
          <div className="flex items-center space-x-4">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-gray-900">CMC</span>
                <span className="text-xs text-gray-500 -mt-1">商務管理中心</span>
              </div>
            </Link>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white rounded-lg mt-2 border border-gray-200">
              ...
              <div className="border-t border-gray-200 pt-2 mt-2">
                <button onClick={toggleDarkMode} className="flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 w-full">
                  {darkMode ? <Sun className="h-4 w-4" /> : <Moon className="h-4 w-4" />}
                  <span>{darkMode ? '淺色模式' : '深色模式'}</span>
                </button>
                <Link href="/profile" className="flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100" onClick={() => setMobileMenuOpen(false)}>
                  <User className="h-4 w-4" />
                  <span>個人資料</span>
                </Link>
              </div>
