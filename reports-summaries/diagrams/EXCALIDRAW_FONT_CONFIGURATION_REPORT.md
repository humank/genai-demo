...
This project現在已完全配置為在所有 Excalidraw 圖表中統一使用 **Excalifont** 字型，確保視覺一致性和專業外觀。
...
3. **User (User)**: 橙色系 - `#f57c00`, `#fff3e0`, `#e65100`
4. **Process (流程)**: 紫色系 - `#7b1fa2`, `#f3e5f5`, `#4a148c`

### Templates
標準化的元素模板：

- **Bounded Context**: 150x80 矩形，Excalifont 14px
- **Stakeholder**: 120x80 橢圓，Excalifont 14px
